  ...
  <div class="header">
    <div class="content-wrapper">
      ...
      <div class ="content">
        ...
        <div class="description" v-text="seller.description +seller.time+'分钟送达'"></div>
        <div v-if="seller.supports" class="support">
          <span class="icon discount" :class="classMap[seller.supports[0].type]"></span>
    ...
    <div v-show="detailShow" class="detail">
      ...
      <div class="detail-close">
        <i class="icon-close" @click="hiddeDetail"></i>
      </div>
...
export default {
  ...
  created () {
    this.classMap = ['decrease', 'discount', 'special', 'inovice', 'guarantee']
  },
  methods: {
    showDetail () {
